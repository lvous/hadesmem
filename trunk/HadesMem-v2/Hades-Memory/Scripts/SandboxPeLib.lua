if HadesMem.IsAMD64() then
	HadesMem.WriteLn("Opening Hades-MemSandbox_AMD64.");
	MyMem = HadesMem.MemoryMgr("Hades-MemSandbox_AMD64.exe");
else
	HadesMem.WriteLn("Opening Hades-MemSandbox_IA32.");
	MyMem = HadesMem.MemoryMgr("Hades-MemSandbox_IA32.exe");
end
